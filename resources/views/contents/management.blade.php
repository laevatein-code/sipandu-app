    ...
    <div class="p-4 rounded-lg mt-14">
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <h2 class="text-title-md2 font-bold text-black dark:text-white text-2xl">Daftar Workspace</h2>
                <p class="font-medium">Sipandu / Management</p>
            </div>
            <div class="flex flex-col gap-y-4 rounded-sm border bg-white p-3 shadow-sm sm:flex-row sm:items-center sm:justify-between">
                <div class="flex gap-4">
                    <div class="flex items-center">
                        <h3 class="text-xl items-center">Total Workspace</h3>    
                    </div>
                    <a href="/modal/management/tambah">
                ...
                <div>
                    <h3 class="text-xl items-center">{{ $workspace->count() }} Kelompok Tugas</h3>
                </div>
            </div>
            <div class="mt-6 flex flex-col gap-6">
                <div class="flex flex-col gap-5">
                    <h4 class="text-xl font-bold text-black dark:text-white">{{ auth()->user()->info->seksi }} Workspace</h4>
                            ...
                            <table class="w-full table-auto">
                                <thead>
                                    <tr class=" bg-gray-200 text-left">
                                        ...
                                        <th class="min-w-[220px] px-4 py-4 font-medium text-black dark:text-white xl:pl-11">Anggota</th>
                                ...
                                <tbody>
                                    ...
                                    @if ($w->seksi->seksi == auth()->user()->info->seksi)
                                    ...
                                    <tr>
                                        ...
                                        <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">{{ $w->author }}</td>
                                        <td class="border-b border-[#eee] px-4 py-5 pl-9 dark:border-strokedark xl:pl-11">
                                            <div class="flex items-center space-x-3.5">
                                                <a href="/contents/management/{{ $w->id }}/edit"><button type="button" class="hover:text-blue-700">
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4">
                                                        <path d="M21.731 2.269a2.625 2.625 0 0 0-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 0 0 0-3.712ZM19.513 8.199l-3.712-3.712-12.15 12.15a5.25 5.25 0 0 0-1.32 2.214l-.8 2.685a.75.75 0 0 0 .933.933l2.685-.8a5.25 5.25 0 0 0 2.214-1.32L19.513 8.2Z" />
                                                      </svg>                                              
                                                </button></a>
                                                <form action="{{ route('management.delete', $w->id) }}" method="POST">
                                                    @csrf
                                                    @method('delete')
                ...
                <div class="flex flex-col gap-5">
                    <h4 class="text-xl font-bold text-black dark:text-white">Semua Workspace</h4>
                    <div class="relative flex flex-col justify-between rounded-sm border bg-white p-7 shadow-sm">
                        <div class="max-w-full overflow-x-auto">
                            <table class="w-full table-auto">
                                <thead>
