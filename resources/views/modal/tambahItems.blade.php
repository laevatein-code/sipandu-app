    ...
    <div class="p-4 rounded-lg mt-14">
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <h2 class="font-bold text-black dark:text-white text-2xl">Tambah Items</h2>
            ...
            <div class="rounded-sm border shadow-sm bg-white px-5 pb-2.5 pt-6 sm:px-7 xl:pb-1">
                <div class="flex flex-col">
                    ...
                    <form action="/modal/items/{{ $id_w }}" method="POST">
                        @csrf
                        @method('put')
                        <div class="p-6">
                            <div class="mb-4">
                                <label for="nama" class="mb-3 block text-sm font-medium text-black dark:text-white">Nama Items</label>
                                <input required type="text" name="nama" placeholder="Masukan Nama Tugas" class="w-full rounded border-[1.5px] bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-blue-700 active:border-blue-700 disabled:cursor-default disabled:bg-white dark:text-white dark:focus:border-blue-700">
                            </div>
                            <div class="mb-4">
                                <label for="keterangan" class="mb-3 block text-sm font-medium text-black dark:text-white">Keterangan</label>
                                <textarea required type="text" name="keterangan" placeholder="Keterangan Tugas" class="w-full rounded border-[1.5px] bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-blue-700 active:border-blue-700 disabled:cursor-default disabled:bg-white dark:text-white dark:focus:border-blue-700"></textarea>
                            </div>
                            <div class="mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="anggota" placeholder="Masukan nama petugas" class="w-full rounded border-[1.5px] bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-blue-700 active:border-blue-700 disabled:cursor-default disabled:bg-white dark:text-white dark:focus:border-blue-700" required>
                            </div>
                            <div class="mb-4">
                                <label for="upload" class="mb-3 block text-sm font-medium text-black dark:text-white">Masukan petugas</label>
